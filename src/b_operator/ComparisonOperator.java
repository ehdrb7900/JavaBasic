...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%21.20f", 10.1f);
		System.out.printf("%21.20f", 10.1);
		// float과 double은 정밀도가 달라 float을 double로 형변환하면
		// 소수점을 정확하게 비교할 수 없다.
		System.out.printf("%21.20f", (double)10.1f);
		System.out.printf("%21.20f", (float)10.1);
		...
		b = String("abc") == new String("abc"); // new는 새로운 주소를 생성한다.
