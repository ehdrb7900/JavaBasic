...
//		답 : d = 대괄호 안에 크기를 지정해주면 안 됨.
//			e = 배열 선언시 크기를 지정해 줄 수 없음.
		
//		[5-2] 다음과 같은 배열이 있을 때, arr[3].length의 값은 얼마인가?
//				
//			int[][] arr = { {5, 5, 5, 5, 5}, {10, 10, 10}, 
//							{20, 20, 20, 20}, {30, 30} };
...
//		[Hint] 나눗셈 연산자와 나머지 연산자를 사용해야 한다.
		...
		/*class Exercise5_6 { public static void main(String args[]) { 
...
//			if (money <= (coin[i] + 1) * coinUnit[i]){
//				coinNum = money / coinUnit[i];
//				coin[i] -= coinNum;
//				money %= coinUnit[i];
//			} else if (money > (coin[i] + 1) * coinUnit[i]){
//				coinNum = coin[i];
...
//		답 : result[j][i] = star[star.length - i - 1][j];
...
//		[5-11] 주어진 2차원 배열의 데이터보다 가로와 세로로 1이 더 큰 배열을 생성해서 배열의 행과 열의 
//			마지막 요소에 각 열과 행의 총합을 저장하고 출력하는 프로그램이다. 
//			(1) 에 알맞은 코드를 넣어서 완성하시오.
