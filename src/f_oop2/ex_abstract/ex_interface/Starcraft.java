...
class Tank extends Unit implements Rapairable{
	Tank() {
		super(150);
	}
}

class Dropship extends Unit implements Rapairable{
	Dropship() {
		super(125);
	}
}

class SCV extends Unit implements Rapairable{
	SCV(){
		super(60);
	}
	
	void repair(Rapairable r){
